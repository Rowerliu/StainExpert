...
class BertCLIPModel(CLIPPreTrainedModel):
    ...
    def __init__(self, config: BertCLIPConfig):
        ...
        self.text_projection = nn.Linear(self.text_embed_dim, self.projection_dim_1, bias=False)
    ...
    def get_text_features(
        ...
        pooled_output = text_outputs[0]  # 1,13,768
        text_features = self.text_projection(pooled_output)  # 1,13,512
