...
def parse_args_paired_training(input_args=None):
   ...
   """
    ...
    parser.add_argument("--viz_freq", type=int, default=1, help="Frequency of visualizing the outputs.")  # 100
...
def parse_args_unpaired_training():
   ...
   """
    ...
    parser.add_argument("--classes", default=['IHC', 'mpIFb', 'mpIFg', 'mpIFy'], type=list)
    # parser.add_argument("--classes", default=['HE', 'MAS', 'PAS', 'PASM'], type=list)
    # parser.add_argument("--classes", default=['HE', 'ER', 'HER2', 'KI67', 'PGR'], type=list)
    ...
    parser.add_argument("--expert_assign_ratio", default=0.2, type=float, help='disable: 0')  # split expert output or fusion output
    parser.add_argument("--fusion_method", default="cross_attention", type=str, choices=["concat", "cross_attention", "film"])
    parser.add_argument("--expert_diversity_weight", default=0.5, type=float)
    parser.add_argument("--expert_balancing_strength", default=0.5, type=float)
    ...
    parser.add_argument("--train_dataset_folder", type=str,
                        default=r'F:\13_Data\03_Pathology\56_DeepLIIF\02_train\r384_ihc-revert')  # fixme
    parser.add_argument("--val_dataset_folder", type=str,
                        default=r'F:\13_Data\03_Pathology\56_DeepLIIF\03_test\r256_ihc-revert')  # fixme
    parser.add_argument("--train_img_prep", type=str, default="random_crop_256")  # crop_128
    parser.add_argument("--val_img_prep", type=str, default="center_crop_256")  # crop_128  no_resize
    parser.add_argument("--dataloader_num_workers", type=int, default=0)
    ...
    parser.add_argument("--viz_freq", type=int, default=100)  # 1000
    parser.add_argument("--output_dir", type=str, default=r'01_result\20250425_DeepLIIF-c384_expert-split-4-2')  # fixme
    parser.add_argument("--report_to", type=str, default="wandb")  # wandb
    parser.add_argument("--tracker_project_name", type=str, default="train_lzy_V15")  # fixme
    parser.add_argument("--validation_steps", type=int, default=1000)  # 20000
    ...
    parser.add_argument("--checkpointing_steps", type=int, default=1000)  # 20000
